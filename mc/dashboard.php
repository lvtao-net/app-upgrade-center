...
<body class="bg-light">
    <div class="container py-5">
        ...
        <div class="mt-4">
            <a href="apps.php" class="btn btn-primary">应用管理</a>
            <a href="versions.php" class="btn btn-secondary">版本管理</a>
            <a href="dbm.php" class="btn btn-success">数据库管理</a>
    ...
    <div class="container py-5">
        ...
        <pre>
协议POST
https://apps.sdxtsz.com/app/check.php
{
  id:appid,
  p:platform,
  v:appVersion,
...
version 版本号 2.0
        ...
        <h3>uni-app示例</h3>
        <p>特别说明，安卓需要添加俩个权限 `android.permission.INSTALL_PACKAGES` 和 `android.permission.REQUEST_INSTALL_PACKAGES`</p>
        <p>app-update.js</p>
        <pre>
...
function drawtext(text, maxWidth) {
	...
	return rowText
        ...
        <p>使用</p>
        <pre>
import appUpdate from './config/app-update'
export default {
	onLaunch() {
	    // APP模式下检测更新，这儿的数字1表示的就是appid
